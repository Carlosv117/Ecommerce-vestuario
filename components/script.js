...
const cards = [
  {
    ...
    img_url: "img/Men-Jacket-Front-Black__15466 1.png",
  ...
  },
  {
    ...
    value: "Acessórios",
    name: "Mask",
    img_url: "img/Surgical-Mask-Black__89554 1.png",
    descrição: "Foto Mask",
    parag:
  ...
  },
  {
    ...
    value: "Camisetas",
    name: "T-Shirt",
    img_url: "img/Men-TShirt-Black-Front__70046 1.png",
  ...
  },
  {
    ...
    img_url: "img/mockup-a0dc2330__62146 1.png",
  ...
  },
  {
    ...
    img_url: "img/mockup-9b9894f1__67347 1.png",
...
function adicionarItens(produto) {
  ...
  produtoAdicionar.addEventListener("click", function (e) {
    ...
    carrinhoFuncionando();
    // footerFuncionando();
    // carrinhoItens.classList.remove("itens");
    // carrinhoItens.classList.add("itensHidden");
    // footerPreçoHidden.classList.remove("footerPreçoHidden");
    // footerPreçoHidden.classList.add("footerPreço");
  });
...
// FOOTER FUNCIONANDO
// function footerFuncionando() {
//   if (carrinhoArray.length === 0) {
//     totalQntd.parentElement.remove();
//     totalPreço.parentElement.remove();
//   } else if (carrinhoArray.length > 0) {
//     addToCart();
//   }
// }
